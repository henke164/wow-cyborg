...
function RenderMultiTargetRotation()
  ...
  if fwDebuff ~= nil and IsMelee() then
  ...
  if fwDebuff ~= nil then
    if IsCastableAtEnemyTarget("Clawing Shadows", 0) and runeCount > 0 and fwStacks > 0 then
      WowCyborg_CURRENTATTACK = "Clawing Shadows";
      return SetSpellRequest(clawingShadows);
    end
  end
